      ...
      >
        ...
        >
          <div className="sm:text-center lg:text-left">
            ...
            >
              A Frontend and Fullstack Developer specializing in creating intuitive and dynamic user interfaces as well as developing robust backend solutions. I focus on building seamless web applications that drive the success of the overall product, ensuring both the client-side and server-side components work harmoniously to deliver exceptional user experiences.
            </p>
